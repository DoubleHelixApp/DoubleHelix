...
def test_base_conversion():
    assert UnitPrefix.convert(10**-15, 3) == "0.001 p"
    assert UnitPrefix.convert(10**-14, 2) == "0.01 p"
    assert UnitPrefix.convert(10**-13) == "0.1 p"
    assert UnitPrefix.convert(10**-12) == "1 p"
    assert UnitPrefix.convert(10**-11) == "10 p"
    assert UnitPrefix.convert(10**-10) == "100 p"
    assert UnitPrefix.convert(10**-9) == "1 n"
    assert UnitPrefix.convert(10**-8) == "10 n"
    assert UnitPrefix.convert(10**-7) == "100 n"
    assert UnitPrefix.convert(10**-6) == "1 μ"
    assert UnitPrefix.convert(10**-5) == "10 μ"
    assert UnitPrefix.convert(10**-4) == "100 μ"
    assert UnitPrefix.convert(10**-3) == "1 m"
    assert UnitPrefix.convert(10**-2) == "10 m"
    assert UnitPrefix.convert(10**-1) == "100 m"
    ...
    assert UnitPrefix.convert(10**3) == "1 k"
    assert UnitPrefix.convert(10**4) == "10 k"
    assert UnitPrefix.convert(10**5) == "100 k"
    assert UnitPrefix.convert(10**6) == "1 M"
    assert UnitPrefix.convert(10**7) == "10 M"
    assert UnitPrefix.convert(10**8) == "100 M"
    assert UnitPrefix.convert(10**9) == "1 G"
    assert UnitPrefix.convert(10**10) == "10 G"
    assert UnitPrefix.convert(10**11) == "100 G"
    assert UnitPrefix.convert(10**12) == "1 T"
    assert UnitPrefix.convert(10**13) == "10 T"
    assert UnitPrefix.convert(10**14) == "100 T"
    assert UnitPrefix.convert(10**15) == "1 P"
    assert UnitPrefix.convert(10**16) == "10 P"
    assert UnitPrefix.convert(10**17) == "100 P"
    assert UnitPrefix.convert(10**18) == "1000 P"
    assert UnitPrefix.convert(10**19) == "10000 P"
